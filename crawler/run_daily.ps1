...
# 已全覆盖：36 家公司社招（阿里系 8 站：集团/淘天/饿了么/国际/云/通义/钉钉/夸克）；百川无公开社招
$socialKeys = @(
  ...
  'oppo_social',                                                        # custom 社招（用户提供入口）
  'alibaba_social','taotian_social','ele_social','aidc_social',        # 阿里系同构 ×8（共享 ali_social_common.js，城市分片）
  'aliyun_social','tongyi_social','dingtalk_social','quark_social'    # 阿里系同构续
)
